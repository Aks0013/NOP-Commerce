...
@Test
  public void f() throws InterruptedException, IOException {
			...
			WebDriver driver=new ChromeDriver();
			  ...
			  WebElement date=driver.findElement(By.xpath("//*[@id='ui-datepicker-div']/div[2]/table/tbody/tr[2]/td[3]"));
			  date.click();
			  driver.manage().timeouts().implicitlyWait(5,TimeUnit.SECONDS);
			  ...
			  passengers.click();
			  WebElement checkbox=driver.findElement(By.xpath("//*[@id=\"ControlGroupSearchView_AvailabilitySearchInputSearchView_Defense\"]"));
			  checkbox.click();
			  ...
			  Files.copy(s, new File("./Screenshot/"+"srcshot3.png"));
			  driver.quit();
